...
public record CreateEdtDto(DateOnly jour, TimeOnly hDeb, TimeOnly hFin, string dispo, int nbH, string type, string responsableId, int idSalle, string enseignantId, int mentionId, int niveauId, string matiereId, int anneeId, string semaine);
